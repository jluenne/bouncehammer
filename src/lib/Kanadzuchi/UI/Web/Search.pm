# $Id: Search.pm,v 1.32.2.4 2013/08/30 05:54:48 ak Exp $
...
sub onlinesearch {
    ...
    if( $downloadx ) {
        ...
        my $archivecn = 'Kanadzuchi::Archive::';
        ...
        $self->header_props(
                ...
                '-content-disposition' => 'attachment;filename='.$zippedobj->output->basename,
