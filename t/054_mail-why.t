# $Id: 054_mail-why.t,v 1.8.2.3 2013/07/17 04:13:05 ak Exp $
...
my $Classes = {
    ...
    'expired'       => q(Kanadzuchi::Mail::Why::Expired),
    'suspend'       => q(Kanadzuchi::Mail::Why::Suspend),
...
my $Strings = {
    ...
    'expired' => [
        q(delivery time expired),
        q(connection timed out in connect),
    ],
    'suspend' => [
