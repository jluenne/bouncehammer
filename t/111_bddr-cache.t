# $Id: 111_bddr-cache.t,v 1.2.2.1 2013/08/30 23:05:12 ak Exp $
...
METHODS: {
    ...
    my $tables = [ qw/
        t_bouncelogs t_addressers t_senderdomains t_hostgroups 
    ...
    CONSTRUCTOR: {
        isa_ok( $object->cache, 'HASH', '->cache is HASH reference' );
        isa_ok( $object->count, 'HASH', '->count is HASH reference' );
    }
